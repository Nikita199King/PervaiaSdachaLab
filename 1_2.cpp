...
public:
    ...
    // Переопределение метода displayInfo для вывода способности босса
    void displayInfo() const override {
...
int main() {
    ...
    Enemy monster("Monstrik", 50, "Monstrik");
    Boss megaBoss("MegaBoss", 300, "MegaBoss", "Fire Breath");

    // Выводим информацию о персонажах
    hero.displayInfo();
    monster.displayInfo();
    megaBoss.displayInfo();
